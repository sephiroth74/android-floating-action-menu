...
public class FloatingActionMenu implements AbsListView.OnScrollListener, View.OnClickListener {
	...
	private void layout() {
		...
		for (FloatingActionItemImageView view : itemViews) {
			if (! measured) view.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
	...
	public void onScroll(
		...
		if (totalItemCount == 0 || ! mScrollStarted) return;
	...
	static public class Builder {
		...
		private final List<FloatingActionItem> items = new ArrayList<FloatingActionItem>();
